...
class RatingBarSvg @JvmOverloads constructor(
    ...
    private fun getBitmapDrawableFromVectorDrawable(drawable: Drawable): BitmapDrawable {
        val bitmap = Bitmap.createBitmap(
            (drawable.intrinsicWidth + resources.getDimension(R.dimen.movie_main_item_ratingbar_stars_padding_between)).toInt(), //dp between svg images  //* resources.displayMetrics.density
