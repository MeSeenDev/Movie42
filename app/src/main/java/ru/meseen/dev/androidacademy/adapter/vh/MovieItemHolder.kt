...
class MovieItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    fun bind(itemMovieData: MovieItem, application: Application) {

        var temp = itemMovieData.genreIds.joinToString { "$it" }
        genres.text = temp
        temp = "${itemMovieData.voteCount} REVIEVS"
    ...
    private fun loadImage(itemMovieData: MovieItem, application: Application) {
